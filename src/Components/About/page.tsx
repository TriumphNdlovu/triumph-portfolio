    ...
    >
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-6">
        {/* Profile Image */}
          ...
          <div className="relative w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden border-4 hover:border-yellow-500 border-neonGreen shadow-md group">
            {/* Default Image */}
            <Image
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-6xl">
          ...
          <h2 className="text-lg md:text-2xl font-pixel text-yellow-500 mb-4">
          ...
          <div className="w-full p-6 rounded-lg border border-neonGreen shadow-md"> 
            ...
            <p className="text-white font-vt323 text-lg leading-relaxed mb-4"> 
              I work with <span className="text-yellow-400">Next.js</span>, <span className="text-yellow-400">Node.js</span>,  
              <span className="text-yellow-400">Tailwind CSS</span>, and <span className="text-yellow-400">Java</span> to build web applications that look and work great. 
            </p> 
            <p className="text-white font-vt323 text-lg leading-relaxed mb-4"> 
