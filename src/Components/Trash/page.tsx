export default function Trash() {
  return (
    <section className="p-8 text-center relative">
      ...
      <div className="bg-gray-900 p-8 rounded-lg border border-neonGreen shadow-lg max-w-3xl mx-auto">
        <p className="text-lg text-gray-300 font-vt323 mb-8 leading-relaxed">
          Welcome to my retro-themed portfolio! Here’s a quick guide to help
          you navigate and enjoy the experience.
        </p>
